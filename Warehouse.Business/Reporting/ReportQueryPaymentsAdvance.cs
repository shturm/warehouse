...
{
    public class ReportQueryPaymentsAdvance : ReportQueryBase
    {
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPaymentsAdvance (dataQuery);
        }
    }
}
