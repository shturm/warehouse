...
{
    public class ReportQuerySalesByItem : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportSalesByGoods.html"; }
        }

        public ReportQuerySalesByItem ()
        {
            Name = Translator.GetString ("Sales by Item Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportSalesByItems (dataQuery);
        }
