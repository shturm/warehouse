...
{
    public class ReportQueryOperations : ReportQueryBase
    {
        public ReportQueryOperations ()
        {
            Name = Translator.GetString ("Operations Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportOperations (dataQuery);
        }
