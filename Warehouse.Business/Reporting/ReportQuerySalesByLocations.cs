//
// ReportQuerySalesByLocations.cs
//
// Author:
...
{
    public class ReportQuerySalesByLocations : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportSalesByPointsOfSale.html"; }
        }

        public ReportQuerySalesByLocations ()
        {
            Name = Translator.GetString ("Sales by Location Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportSalesByLocations (dataQuery);
        }
