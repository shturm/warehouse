//
// ReportQueryComplexProductions.cs
//
// Author:
...
{
    public class ReportQueryComplexProductions : ReportQueryBase
    {
        public ReportQueryComplexProductions ()
        {
            Name = Translator.GetString ("Productions Report");
            ...
            AppendFilter (new FilterCompare (true, true, DataFilterLabel.OperationSum, DataField.OperationDetailSumIn));
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportComplexProductions (dataQuery);
        }
