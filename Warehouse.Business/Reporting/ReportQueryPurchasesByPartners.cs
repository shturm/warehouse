//
// ReportQueryPurchasesByPartners.cs
//
// Author:
...
{
    public class ReportQueryPurchasesByPartners : ReportQueryBase
    {
        public ReportQueryPurchasesByPartners ()
        {
            Name = Translator.GetString ("Purchases by Partners Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPurchasesByPartners (dataQuery);
        }
