...
{
    public class ReceiptReportReturns : ReceiptReport
    {
        ...
        {
            get { return Translator.GetString ("Returns"); }
        }
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportReturnsByUser (GetDataQuery ());
        }
