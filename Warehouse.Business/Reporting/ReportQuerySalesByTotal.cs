...
{
    public class ReportQuerySalesByTotal : ReportQueryBase
    {
        public ReportQuerySalesByTotal ()
        {
            Name = Translator.GetString ("Sales by Amount Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportSalesByTotal (dataQuery);
        }
