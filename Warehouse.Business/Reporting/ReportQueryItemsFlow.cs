...
{
    public class ReportQueryItemsFlow : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportGoodsMovement.html"; }
        }

        public ReportQueryItemsFlow ()
        {
            Name = Translator.GetString ("Items Flow Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportItemsFlow (dataQuery);
        }
