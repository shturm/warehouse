...
{
    public class ReportQueryPurchases : ReportQueryBase
    {
        public ReportQueryPurchases ()
        {
            Name = Translator.GetString ("Purchases Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPurchases (dataQuery);
        }
