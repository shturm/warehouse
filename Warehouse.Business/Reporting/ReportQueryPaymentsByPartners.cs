//
// ReportQueryPaymentsByPartners.cs
//
// Author:
...
{
    public class ReportQueryPaymentsByPartners : ReportQueryBase
    {
        public ReportQueryPaymentsByPartners ()
        {
            Name = Translator.GetString ("Payments by Partners");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPaymentsByPartners (dataQuery);
        }
