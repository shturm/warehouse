...
{
    public class ReportQueryInvoicesIssued : ReportQueryBase
    {
        public ReportQueryInvoicesIssued ()
        {
            Name = Translator.GetString ("Issued Invoices Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportInvoicesIssued (dataQuery);
        }
