...
{
    public class ReportQueryStockTakings : ReportQueryBase
    {
        public ReportQueryStockTakings ()
        {
            Name = Translator.GetString ("Stock-taking Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportStockTakings (dataQuery);
        }
