...
{
    public class ReportQueryPaymentsHistory : ReportQueryBase
    {
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPaymentsHistory (dataQuery);
        }
