//
// ReportQueryLocationsByProfit.cs
//
// Author:
...
{
    public class ReportQueryLocationsByProfit : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportPointsOfSaleByProfit.html"; }
        }

        public ReportQueryLocationsByProfit ()
        {
            Name = Translator.GetString ("Profit by Locations Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportLocationsByProfit (dataQuery);
        }
