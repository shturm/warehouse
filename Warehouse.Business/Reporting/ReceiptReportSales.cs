...
{
    public class ReceiptReportSales : ReceiptReport
    {
        ...
        {
            get { return Translator.GetString ("Sales"); }
        }
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportSalesByUser (GetDataQuery ());
        }
