//
// ReportQueryPartnersByProfit.cs
//
// Author:
...
{
    public class ReportQueryPartnersByProfit : ReportQueryBase
    {
        public ReportQueryPartnersByProfit ()
        {
            Name = Translator.GetString ("Profit by Partners Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPartnersByProfit (dataQuery);
        }
