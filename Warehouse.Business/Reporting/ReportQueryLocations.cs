...
{
    public class ReportQueryLocations : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportPointsOfSale.html"; }
        }

        public ReportQueryLocations ()
        {
            Name = Translator.GetString ("Locations Report");
            ...
            AppendFilter (new FilterFind (true, true, DataFilterLabel.LocationCode, DataField.LocationCode));
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportLocations (dataQuery);
        }
