...
{
    public class ReportQuerySalesByPartners : ReportQueryBase
    {
        public ReportQuerySalesByPartners ()
        {
            Name = Translator.GetString ("Sales by Partner Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportSalesByPartners (dataQuery);
        }
