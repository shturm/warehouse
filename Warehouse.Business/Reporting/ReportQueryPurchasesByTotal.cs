//
// ReportQueryPurchasesByTotal.cs
//
// Author:
...
{
    public class ReportQueryPurchasesByTotal : ReportQueryBase
    {
        public ReportQueryPurchasesByTotal ()
        {
            Name = Translator.GetString ("Purchases by Amount Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPurchasesByTotal (dataQuery);
        }
