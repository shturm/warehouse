//
// ReportQueryPurchasesByItems.cs
//
// Author:
...
{
    public class ReportQueryPurchasesByItems : ReportQueryBase
    {
        public override string HelpFile
        {
            get { return "ReportPurchasesByGoods.html"; }
        }

        public ReportQueryPurchasesByItems ()
        {
            Name = Translator.GetString ("Purchases by Items Report");
        ...
        {
            return BusinessDomain.DataAccessProvider.ReportPurchasesByItems (dataQuery);
        }
