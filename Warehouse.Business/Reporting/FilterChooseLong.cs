...
{
    public class FilterChooseLong : FilterBase
    {
        private readonly KeyValuePair<long, string> [] values;
        ...
        public FilterChooseLong (bool constantVisibility, bool columnVisible, KeyValuePair<long, string> [] values, DataFilterLabel filter, params DbField [] fNames)
        ...
        public override string GetExplanation ()
        {
            ...
            foreach (KeyValuePair<long, string> pair in values) {
