...
{
    public class ItemAlwaysBrowse : ISuggestionProvider
    {
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblTitle = new Label { Markup = new PangoStyle { Size = PangoStyle.TextSize.Large, Text = Translator.GetString ("Always browse all items") }, Xalign = 0 };
