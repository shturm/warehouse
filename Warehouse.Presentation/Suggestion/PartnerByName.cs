...
namespace Warehouse.Presentation.Suggestion
{
    ...
    public class PartnerByName : ISuggestionProvider
    {
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblName = new Label { Markup = new PangoStyle { Bold = true, Text = Translator.GetString ("Name:") } };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            if (handler != null)
                handler (this, new EntitySuggestedEventArgs (new Partner { Name = value }));
        }
    }
}
