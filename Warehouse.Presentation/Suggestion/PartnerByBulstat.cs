...
namespace Warehouse.Presentation.Suggestion
{
    ...
    public class PartnerByBulstat : ISuggestionProvider
    {
        ...
        public SuggestionEntityType SupportedEntities { get { return SuggestionEntityType.Partner; } }
        ...
        public bool CheckAvailableFor (string value)
        {
            ...
            return value.Length >= 9 && value.Length <= 13 && value.All (char.IsDigit);
        }
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblTitle = new Label { Markup = new PangoStyle { Size = PangoStyle.TextSize.Large, Text = Translator.GetString ("Create a new partner with:") }, Xalign = 0 };
            vbo.PackStart (lblTitle);

            HBox hbo = new HBox { Spacing = 4 };
            Label lblName = new Label { Markup = new PangoStyle { Bold = true, Text = Translator.GetString ("UIC:") } };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            if (handler != null)
                handler (this, new EntitySuggestedEventArgs (new Business.Entities.Partner { Bulstat = value }));
        }
    }
}
