...
namespace Warehouse.Presentation.Suggestion
{
    ...
    public class PartnerByCard : ISuggestionProvider
    {
        ...
        public bool CheckAvailableFor (string value)
        {
            ...
            return digits * 10 > value.Length * 8;
        }
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblName = new Label { Markup = new PangoStyle { Bold = true, Text = Translator.GetString ("Card number:") } };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            if (handler != null)
                handler (this, new EntitySuggestedEventArgs (new Business.Entities.Partner { CardNumber = value }));
        }
    }
}
