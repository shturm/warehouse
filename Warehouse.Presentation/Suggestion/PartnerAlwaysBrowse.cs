...
{
    public class PartnerAlwaysBrowse : ISuggestionProvider
    {
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            hboMain.PackStart (FormHelper.LoadImage ("Icons.Partner32.png"), false, true, 0);
            Label lblTitle = new Label { Markup = new PangoStyle { Size = PangoStyle.TextSize.Large, Text = Translator.GetString ("Always browse all partners") }, Xalign = 0 };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            BusinessDomain.AppConfiguration.ShowPartnerSuggestionsWhenNotFound = false;
