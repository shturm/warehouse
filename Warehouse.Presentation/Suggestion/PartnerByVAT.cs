...
namespace Warehouse.Presentation.Suggestion
{
    ...
    public class PartnerByVAT : ISuggestionProvider
    {
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblName = new Label { Markup = new PangoStyle { Bold = true, Text = Translator.GetString ("VAT number:") } };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            if (handler != null)
                handler (this, new EntitySuggestedEventArgs (new Business.Entities.Partner { TaxNumber = value }));
        }
    }
}
