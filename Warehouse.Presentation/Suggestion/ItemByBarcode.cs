...
namespace Warehouse.Presentation.Suggestion
{
    ...
    public class ItemByBarcode : ISuggestionProvider
    {
        ...
        public bool CheckAvailableFor (string value)
        {
            ...
            return value.Length >= 13 && value.Length <= 14 && value.All (char.IsDigit);
        }
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblName = new Label { Markup = new PangoStyle { Bold = true, Text = Translator.GetString ("Barcode:") } };
        ...
        private void btn_Clicked (object sender, EventArgs e)
        {
            ...
            if (handler != null)
                handler (this, new EntitySuggestedEventArgs (new Business.Entities.Item { BarCode = value }));
        }
    }
}
