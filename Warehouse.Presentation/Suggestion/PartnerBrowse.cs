...
{
    public class PartnerBrowse : ISuggestionProvider
    {
        ...
        public Widget [] GetWidget (string value, object operation)
        {
            ...
            Label lblTitle = new Label { Markup = new PangoStyle { Size = PangoStyle.TextSize.Large, Text = Translator.GetString ("Browse all partners") }, Xalign = 0 };
