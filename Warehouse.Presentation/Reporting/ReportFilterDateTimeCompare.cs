//
// ReportFilterDateTimeCompare.cs
//
// Author:
...
{
    public class ReportFilterDateTimeCompare : ReportFilterBase<FilterDateTimeCompare>
    {
        private Entry txtCompareTo;
        private ComboBox cboSign;

        public ReportFilterDateTimeCompare (bool alwaysOn, bool enabled, DataFilterLabel fLabel, params DbField [] fNames)
            : this (new FilterDateTimeCompare (alwaysOn, enabled, fLabel, fNames))
        {
        }

        public ReportFilterDateTimeCompare (FilterDateTimeCompare filter)
            : base (filter)
        {
            InitializeWidgets ();
        ...
        private void InitializeWidgets ()
        {
            ...
            cboSign.Load (Translator.GetReportFilterDateTimeCompareLogics (), "Key", "Value");
        ...
        public override void ClearFilter ()
        {
            ...
            cboSign.SetSelection (Translator.GetReportFilterDateTimeCompareLogics (), "Key", "Value", (int) filter.FilterLogic);
        }
